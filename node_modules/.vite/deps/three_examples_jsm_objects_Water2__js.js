...
var Water = class _Water extends Mesh {
  ...
  constructor(geometry, options = {}) {
    ...
    const flowDirection = options.flowDirection !== void 0 ? options.flowDirection : new Vector2(1, 0);
    const flowSpeed = options.flowSpeed !== void 0 ? options.flowSpeed : 0.03;
    const reflectivity = options.reflectivity !== void 0 ? options.reflectivity : 0.02;
    const scale = options.scale !== void 0 ? options.scale : 1;
    const shader = options.shader !== void 0 ? options.shader : _Water.WaterShader;
...
//# sourceMappingURL=three_examples_jsm_objects_Water2__js.js.map
